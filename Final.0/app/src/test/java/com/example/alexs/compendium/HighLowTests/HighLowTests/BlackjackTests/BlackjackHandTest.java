...
public class BlackjackHandTest {
    ...
    public void setUp() {
        ...
        blackjackCard = new BlackjackCard(Suit.CLUBS, BlackjackRank.KING);
    }
...
// Check different hand rankings for Blackjack work correctly

    @Test
    public void handHasValue(){
        blackjackHand.addCard(blackjackCard);
        assertEquals(10, blackjackHand.getHandValue());
    }
